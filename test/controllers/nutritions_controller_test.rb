...
class NutritionsControllerTest < ActionController::TestCase
  ...
  test "should create nutrition" do
    assert_difference('Nutrition.count') do
      post :create, nutrition: { calorie: @nutrition.calorie, carbohydrate: @nutrition.carbohydrate, fiber: @nutrition.fiber, protein: @nutrition.protein, serving: @nutrition.serving, sodium: @nutrition.sodium }
    end
  ...
  test "should update nutrition" do
    patch :update, id: @nutrition, nutrition: { calorie: @nutrition.calorie, carbohydrate: @nutrition.carbohydrate, fiber: @nutrition.fiber, protein: @nutrition.protein, serving: @nutrition.serving, sodium: @nutrition.sodium }
    assert_redirected_to nutrition_path(assigns(:nutrition))
  end
